...
describe('_2048', () => {
  it('state 1, left', () => {
    ...
    ).toEqual([[4, 0, 0, 0], [4, 16, 8, 2], [2, 64, 32, 4], [2048, 64, 0, 0]]);
  });
  ...
  it('state 1, right', () => {
    ...
    ).toEqual([[0, 0, 0, 4], [4, 16, 8, 2], [2, 64, 32, 4], [0, 0, 2048, 64]]);
  });
  ...
  it('state 2, left', () => {
    expect(
      _2048([[2, 2, 4, 8], [4, 0, 4, 4], [16, 16, 16, 16], [32, 16, 16, 32]], 0)
    ).toEqual([[4, 4, 8, 0], [8, 4, 0, 0], [32, 32, 0, 0], [32, 32, 32, 0]]);
  });

  it('state 2, right', () => {
    expect(
      _2048([[2, 2, 4, 8], [4, 0, 4, 4], [16, 16, 16, 16], [32, 16, 16, 32]], 2)
    ).toEqual([[0, 4, 4, 8], [0, 0, 4, 8], [0, 0, 32, 32], [0, 32, 32, 32]]);
  });
});
